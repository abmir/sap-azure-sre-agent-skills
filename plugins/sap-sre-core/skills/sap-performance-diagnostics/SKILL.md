...
- **SRE Proxy also listed** — Also runs live `hdbsql` against the system (`M_LOAD_HISTORY_HOST`, `M_EXPENSIVE_STATEMENTS`, `M_HEAP_MEMORY`) through the command proxy for the freshest evidence.
